        ...
        <div class="step_box">
            ...
            <div class="offer_box">
              <p>
                ...
                <small>B、确认报价</small>
                <span>
                  整体报价<b>${{confirmFee.totalFee||0}}</b>
                </span>
                <span>
                  救援费用：<b>${{confirmFee.rescueFee||0}}</b>
                </span>
                <span>
                  医疗费用：<b>${{confirmFee.medicFee||0}}</b>
                </span>
                <span>
                  案件服务费用：<b>${{confirmFee.caseFee||0}}</b>
                </span>
                </p>
            </div>
        </div>
...
export default {
  ...
  mounted() {
    ...
    this.axios
      .post(
        constants.domain+"rescue/case/detail_case",
        qs.stringify({
          token: that.token,
          caseId: that.caseid
        })
