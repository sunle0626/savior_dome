            ...
            <div v-if="apptodo>0" class="app-aj">
                ...
                <div v-for="(acase,idx) in apptodolst" :key="idx">
                    <div class="clan">
                        ...
                        <span>出险地:{{acase.victimList!=null&&acase.victimList.length>0&&acase.generalLocation!=null?acase.generalLocation.addr:""}}</span>
                        <span>服务诉求:
							<el-popover
                                    placement="bottom"
                                    width="200"
                ...
                <table class="padding-bj pad-0-10" cellpadding="5">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <el-select v-model="reportcase.insuranceCompanyId" class="marginl10 w213" placeholder="保险公司" filterable>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <el-select v-model="reportcase.nation" v-if="reportcase.siteabroadExpr=='境外'"
                                       @change="loadcounties()" class="w120"  placeholder="请选择国家" filterable>
                                <el-option v-for="item in countries" :key="item.value" :label="item.label"
                                           :value="item.value"></el-option>
                            </el-select>
                            
                            <span class="must">*</span>
                            <el-select v-model="reportcase.city" class="w130" placeholder="请选择地区" filterable>
...
export default {
  ...
  methods: {
    genderselect() {
      if (this.reportcase.genderExpr == "女" || this.reportcase.genderExpr==2) {        
        this.reportcase.gender = 2;
      } else {
        this.reportcase.gender = 1;
      }
      console.log(this.reportcase.genderExpr+"-"+this.reportcase.gender);
    },
    ...
    handleAppCase(checked, idx) {
      ...
      if (checked) {
        ...
        if (ow != null) {
          ...
          z.reportcase.caseSrcDesc = o.caseSrcDesc;
        }
      }
    },
    loadcounties() {
      ...
      var z = this;
      var cmd = new Object();
      cmd.url = constants.domain+"rescue/case/counties";
      cmd.data = new Object();
    ...
    loadcompanies() {
      var z = this;
      var cmd = new Object();
      cmd.url = constants.domain+"rescue/user/list_regulator";
      cmd.data = new Object();
      cmd.data.token = this.token;
      cmd.succ = function(r) {
        z.companies = r;
    ...
    getinsurance() {
      var z = this;
      var cmd = new Object();
      cmd.url = constants.domain+"rescue/policy/view";
      cmd.data = new Object();
    ...
    loadAppCases() {
      ...
      var cmd = new Object();
      cmd.url =
        constants.domain+"rescue/case/list_case_collection";
      cmd.data = new Object();
      cmd.data.status = 90;
      cmd.data.token = this.token;
      cmd.succ = function(r) {
    ...
    submitcase() {
      ...
      if (this.typeId) 
        this.reportcase.incidentType = this.typeId;
      if(this.reportcase.weatherIncident!=1){
        this.reportcase.weatherTag=null;
      }
      var cmd = new Object();
      cmd.url = constants.domain+"rescue/case/create";
      cmd.data = new Object();
