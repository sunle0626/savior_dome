    ...
    <div class="par_wrap">
        ...
        <div class="box">
            ...
            <div class="swi_box">
                <div class="top_box">
                    <p>
                        <router-link :to="{name:'ComParinf',params:{token:token},query: {typeId:this.$route.query.typeId,caseid:this.caseid}}">出险信息</router-link>
                        <router-link :to="{name :'ComParcase',params:{token:token},query: {typeId:this.$route.query.typeId,caseid:this.caseid}}">案件进展</router-link>
                    </p>
                </div>
