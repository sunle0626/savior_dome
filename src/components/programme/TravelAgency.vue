<template>
    <div>
    <header class="header">
        <img src="./images/TravelAgency_bg.png" alt="">
        <div class="nav">
            <div class="nav_left">
        ...
        <div class="points_box">
            <h3>每一次出行，都让人安心！</h3>
            <p>大救星为旅行社提供便捷、高效的全球救援，并为旅行团队量身设计整体解决方案。领队可在大救星APP上创建出行群组、绑定保险，并在任何紧急时刻使用一键救命，同时在地图、定位、预警、呼叫等工具的辅助下，为团队成员提供令人安心的出行安全服务。</p>
        </div>
    </header>
    <main class="main">
       <ul class="list">
           <li>
               <img src="./images/TravelAgency_icon_01.png" alt="">
               <h4>出行群组</h4>
               <p>定点集散、呼叫团员 实时定位、消息共享</p>
           </li>
           <li>
               <img src="./images/TravelAgency_icon_02.png" alt="">
               <h4>一键救命</h4>
               <p>24小时响应 全球有求必救</p>
           </li>
           <li>
               <img src="./images/TravelAgency_icon_03.png" alt="">
               <h4>安全工具</h4>
               <p>旅行地图、风险预警 出行经验、自救指南</p>
           </li>
       </ul>
       <p class="btn_node">
